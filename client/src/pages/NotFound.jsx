...
const NotFound = () => {
    ...
    return (
        <div className="flex h-screen w-full flex-col items-center justify-center bg-gray-50 px-4">
            ...
            <div className="mt-12 text-sm text-gray-400 hover:text-indigo-600 transition-colors">
                &copy; {new Date().getFullYear()} <a href="https://github.com/sh1vam-03" target="_blank" rel="noopener noreferrer">PrintPortal</a>
            </div>
        </div>
    );
};
