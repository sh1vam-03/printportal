                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-1">
                        ...
                        <button
                            ...
                            className="bg-gradient-to-tr from-brand-600 to-indigo-600 hover:bg-brand-700 hover:to-indigo-700 text-white text-sm font-medium px-5 py-2.5 rounded-full shadow-lg shadow-gray-900/10 hover:shadow-gray-900/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
                        >
                            Login
                        </button>
                    </nav>
            ...
            <footer className="bg-white border-t border-gray-100 pb-8 pt-12">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
                        <p>&copy; {new Date().getFullYear()} <Link to="https://github.com/sh1vam-03" target="_blank" className="hover:text-gray-600 transition-colors">PrintPortal</Link>. All rights reserved.</p>
