                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li><button onClick={() => navigate('/')} className="hover:text-brand-600 transition-colors">Submit Request</button></li>
                                <li><button onClick={() => navigate('/')} className="hover:text-brand-600 transition-colors">Track Status</button></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li><button onClick={() => navigate('/help')} className="hover:text-brand-600 transition-colors">Contact Support</button></li>
                            </ul>
                        </div>
                    </div>
