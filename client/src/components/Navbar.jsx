                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative" onClick={(e) => e.stopPropagation()}>
                        <button
                            ...
                            className="flex items-center gap-2 p-1 rounded-full transition-colors hover:bg-gray-50 border border-transparent hover:border-gray-100 transition-all active:scale-95"
                        >
                        ...
                        {isProfileOpen && (
                            <div className="absolute right-0 top-full mt-2 w-60 rounded-2xl bg-white border border-gray-100 shadow-xl shadow-gray-200/50 transform origin-top-right transition-all animate-in fade-in slide-in-from-top-2 overflow-hidden z-50">
                                ...
                                <div className="p-2 space-y-1">
                                    <button onClick={() => navigate('/help')} className="w-full flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 active:bg-gray-100 rounded-xl transition-all font-medium active:scale-[0.98]">
                                    ...
                                    <button onClick={() => navigate('/privacy')} className="w-full flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 active:bg-gray-100 rounded-xl transition-all font-medium active:scale-[0.98]">
                                        <svg className="h-4.5 w-4.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                        </svg>
                                        Privacy Policy
                                    </button>
                                    <button onClick={() => navigate('/terms')} className="w-full flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 active:bg-gray-100 rounded-xl transition-all font-medium active:scale-[0.98]">
                                        <svg className="h-4.5 w-4.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="p-2">
                                    <button
                                        onClick={logout}
                                        className="w-full flex items-center gap-2.5 px-3 py-2.5 text-sm text-rose-600 hover:text-rose-700 hover:bg-rose-50 active:bg-rose-50 rounded-xl transition-all font-medium active:scale-[0.98]"
                                    >
